...
And we use srip plots to check if all variables have plausible values (i.e. they are nor outside the range of the observed values)
...
The estimate from imputed data are not perfect, but they are certainly better than the alternatives.
